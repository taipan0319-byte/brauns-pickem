...
```
python3 v01_picks.py --season 2026 --week N          # Engine A: market picks + log
python3 engine_b.py  --season 2026 --week N          # Engine B: recommendation + log
python3 engine_b.py  --season 2026 --week N --standings standings.json
python3 engine_b.py  --season 2026 --week N --screen # v1.0 weekly screen with confidence
python3 engine_b.py  --season 2026 --week N --fit    # refit family.json from pool_picks.csv
python3 fit_from_scores.py --scores nfl-pool/weekly_scores.csv --season 2025 --write
```
...
Hosted page: https://taipan0319-byte.github.io/brauns-pickem/ (public GitHub Pages, no login).
Source: `dashboard/index.html`, generated by `build_dashboard.py` from the logs. Do not edit the HTML by hand.

**Refresh a week:** `python3 refresh.py --season 2026 --week N [--standings nfl-pool/standings.json]`
...
- `pool_picks.csv`: `season,week,game_id,member,pick,entered_at` for every member including Ryan, after
  ...
  scoreboard can score him. Every few weeks run `python3 engine_b.py --season 2026 --week N --fit` to
